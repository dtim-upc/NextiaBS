 ...
 * @author snadal
 */
public class CSVBootstrap_with_DataFrame_MM extends DataSource implements IBootstrap<Graph> {

	public String path;

	public CSVBootstrap_with_DataFrame_MM(String id, String name, String path) {
		super();
		this.id = id;
		this.name = name;
		this.path = path;
...
//			System.out.println(h2);
			G_target.add(createIRI(h2),RDF.type,DataFrame_MM.Data);
...
//			generateMetadata();
	...
	public static void main(String[] args) throws IOException {
		...
		CSVBootstrap_with_DataFrame_MM csv = new CSVBootstrap_with_DataFrame_MM("12","artworks", pathcsv);
